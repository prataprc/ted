    ...
    fn normal_fold(&mut self, evnt: Event) -> Result<Event> {
        ...
        let (prefix, evnt) = match prefix {
            Event::Noop if m_empty => match evnt {
                ...
                Char('k', _m) => (noop, Mt(Mto::Up(1, DP::None))),
                Up(_m) => (noop, Mt(Mto::Up(1, DP::None))),
                Char('-', _m) => (noop, Mt(Mto::Up(1, DP::TextCol))),
                Char('j', _m) => (noop, Mt(Mto::Down(1, DP::None))),
                Down(_m) => (noop, Mt(Mto::Down(1, DP::None))),
            ...
            N(n) if m_empty => match evnt {
                ...
                // motion command - linewise
                Char('k', _m) => (noop, Mt(Mto::Up(n, DP::None))),
                Up(_m) => (noop, Mt(Mto::Up(n, DP::None))),
                Char('-', _m) => (noop, Mt(Mto::Up(n, DP::TextCol))),
                Char('j', _m) => (noop, Mt(Mto::Down(n, DP::None))),
                Down(_m) => (noop, Mt(Mto::Down(n, DP::None))),
                Enter(_m) => (noop, Mt(Mto::Down(n, DP::None))),
