...
static uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_sel_twins] = STATE(7),
    [sym_sel_siblings] = STATE(7),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sel_siblings, 3),
  [27] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sel_siblings, 3),
  ...
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sel_twins, 3),
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sel_twins, 3),
