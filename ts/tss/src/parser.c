...
enum {
  ...
  sym_field_name = 98,
  sym_sel_field = 99,
  sym_sel_kind_field = 100,
  sym_sel_twins = 101,
  sym_sel_siblings = 102,
  sym_sel_child = 103,
  sym_properties = 104,
  sym_property = 105,
  sym_fg = 106,
...
static uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [aux_sym_sel_kind_token1] = ACTIONS(1),
  ...
  [1] = {
    ...
    [sym_sel_symbol] = STATE(9),
    [sym_sel_kind] = STATE(10),
    [sym_sel_field] = STATE(11),
    [sym_sel_kind_field] = STATE(11),
    [sym_sel_twins] = STATE(11),
    [sym_sel_siblings] = STATE(11),
    [sym_sel_child] = STATE(11),
    [aux_sym_s_repeat1] = STATE(21),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [9] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selector_repeat1, 2),
  [11] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_selector_repeat1, 2), SHIFT_REPEAT(5),
  [14] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_selector_repeat1, 2), SHIFT_REPEAT(46),
  [17] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_selector_repeat1, 2),
  [19] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selector, 1),
  [21] = {.entry = {.count = 1, .reusable = false}}, SHIFT(5),
  [23] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_selector, 1),
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sel_kind_field, 3),
  [27] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sel_kind_field, 3),
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sel_kind, 1),
  [31] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sel_kind, 1),
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sel_twins, 3),
  [35] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sel_twins, 3),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sel_siblings, 3),
  [39] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sel_siblings, 3),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sel_child, 3),
  [43] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sel_child, 3),
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selector_repeat1, 1),
  [47] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_selector_repeat1, 1),
  [49] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [51] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [53] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sel_symbol, 1),
  [57] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sel_symbol, 1),
  [59] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_name, 1),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_field_name, 1),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sel_field, 2),
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sel_field, 2),
  ...
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selectors, 2),
  [83] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_selectors, 2),
  [85] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_selectors_repeat1, 2), SHIFT_REPEAT(25),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selectors_repeat1, 2),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_selectors_repeat1, 2),
  ...
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_s, 1, .production_id = 1),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_s_repeat1, 2, .production_id = 3),
  [106] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_s_repeat1, 2, .production_id = 3), SHIFT_REPEAT(5),
  [109] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_s_repeat1, 2, .production_id = 3), SHIFT_REPEAT(46),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_properties_repeat1, 2, .production_id = 10),
  [114] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_properties_repeat1, 2, .production_id = 10), SHIFT_REPEAT(61),
  [117] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_properties_repeat1, 2, .production_id = 10), SHIFT_REPEAT(60),
  [120] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_properties_repeat1, 2, .production_id = 10), SHIFT_REPEAT(59),
  [123] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_properties_repeat1, 2, .production_id = 10), SHIFT_REPEAT(58),
  ...
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attrs, 2),
  [140] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attrs, 2),
  ...
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attrb, 3),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attrs, 1),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attrs, 1),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attrb, 2),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 2),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_attrs_repeat1, 2),
  [162] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_attrs_repeat1, 2), SHIFT_REPEAT(40),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_attrs_repeat1, 2),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_attrb_repeat1, 2),
  [169] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_attrb_repeat1, 2), SHIFT_REPEAT(38),
  [172] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_attrb_repeat1, 2), SHIFT_REPEAT(38),
  ...
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_properties_repeat1, 2, .production_id = 8),
  [185] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_properties_repeat1, 2, .production_id = 8),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_highlight, 1),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_properties, 3, .production_id = 9),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_properties, 2),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_s_repeat1, 2, .production_id = 2),
  [195] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property, 1, .production_id = 6),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property, 1, .production_id = 7),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property, 1, .production_id = 5),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property, 1, .production_id = 4),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fg, 3),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ansi_color, 1, .production_id = 11),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ansi_color, 1, .production_id = 12),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_color_name, 1),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bg, 3),
